            ...
            function incoming(message, socket) {
                ...
                case 't': { // player toggle
                    ...
                    switch (tog) {
                        ...
                        default: console.warn('Bad toggle.'); return 1;
                    }
                ...
                default: console.warn('Bad packet index.');
                }
            }
            ...
            const spawn = (() => {
                ...
                return (socket, name) => {
                    ...
                    let body = new Entity(loc);
                        ...
                        // "Unnamed" name for people who has a name in violation of the Banned Character Regex.
